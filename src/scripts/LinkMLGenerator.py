...
# -*- coding: utf-8 -*-
"""
execfile("/Users/tu/workspace/iCATX/src/scripts/LinkMLGenerator.py")
"""
execfile("/Users/tu/workspace/iCATX/src/scripts/setup.py")


'''
#Usage: 

This code must be run within Protege 3.x's Protege Script Plugin.

generateLinkMLModels(topClasses, contentModelFile, cmheaderFile) 
'''

topClasses = [ "foobar", "ICDSection", "ContentModelEntity"]
contentModelFile = "/Users/tu/workspace/iCATX/linkMLModels/generated/contentmodel.yaml"
cmheaderFile= "/Users/tu/workspace/iCATX/resources/cmheaders.yaml"
